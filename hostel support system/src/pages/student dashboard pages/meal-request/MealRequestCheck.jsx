...
function MealRequestCheck() {
  ...
  useEffect(() => {
    const loadRequests = async () => {
      try {
        ...
        const res = await loadingFetch(`${API}${Constants.ROUTES.GET_USER_MEAL_REQUESTS}`, {
          credentials: "include"
        })
  ...
  const cancelRequest = async (id) => {
    ...
    try {
      ...
      const res = await loadingFetch(`${API}${Constants.ROUTES.CANCEL_MEAL_REQUEST}/${id}`, {
        method: "DELETE",
        credentials: "include"
      })
...
export default MealRequestCheck
